...
def main():
    ...
    parser.add_argument('root_path', default='/home/xxx/mimic4processed/', type=str, help="Path to root folder containing train and test sets.")
    parser.add_argument('output_path', default='/home/xxx/mimic4processed/in-hospital-mortality/', type=str, help="Directory where the created data should be stored.")
