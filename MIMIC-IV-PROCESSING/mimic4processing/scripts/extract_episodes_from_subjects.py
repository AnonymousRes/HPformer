...
from mimic4processing.preprocessing import assemble_episodic_data
from mimic4processing.preprocessing import read_itemid_to_variable_map, map_itemids_to_variables, clean_events
from mimic4processing.subject import convert_events_to_timeseries, get_first_valid_from_timeseries
from mimic4processing.subject import read_stays, read_diagnoses, read_events, get_events_for_stay, \
...
parser.set_defaults(subjects_root_path='/home/xxx/mimic4processed/')
...
subject_dirs = list(filter(is_subject_folder, subdirectories))

for subject_dir in tqdm(subject_dirs, desc='Iterating over subjects'):
