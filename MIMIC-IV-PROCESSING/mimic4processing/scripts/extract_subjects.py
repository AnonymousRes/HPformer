...
parser.add_argument('mimic4_path', default='/home/xxx/MIMIC-IV/', type=str, help='directory containing mimic-iv csv files.')
parser.add_argument('output_path', default='/home/xxx/mimic4processed/',  type=str, help='directory where per-subject data should be written.')
