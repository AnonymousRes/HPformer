...
parser.add_argument('--data', type=str, help='Path to the data of decompensation task',
                    default='/home/xxx/mimic4processed/decompensation/')
args = parser.parse_args()
print(args)

timestep_ = 1  # hours
print('timestep:', timestep_)
data_set_maxlen = int(24 * 7 * 3 / timestep_) # one weak 1 * 7 * 24 / 1
...
#  mimic4
#  (42386, 168, 76) (42386, 168) (42386, 168) (42386, 168, 1)
#  (7666, 168, 76) (7666, 168) (7666, 168) (7666, 168, 1)
#  (8760, 168, 76) (8760, 168) (8760, 168) (8760, 168, 1)

pickle_file = open('/home/xxx/ehr_data/dp/dp_mimic4_train_data.pkl', 'wb')
pickle.dump(train_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/xxx/ehr_data/dp/dp_mimic4_val_data.pkl', 'wb')
pickle.dump(val_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/xxx/ehr_data/dp/dp_mimic4_test_data.pkl', 'wb')
