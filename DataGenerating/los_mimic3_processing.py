...
parser.add_argument('--data', type=str, help='Path to the data of length-of-stay task',
                    default='/home/xxx/mimic3processed/length-of-stay/')
...
#  mimic3
#  (29168, 168, 76) (29168, 168) (29168, 168) (29168, 168, 10)
#  (6355, 168, 76) (6355, 168) (6355, 168) (6355, 168, 10)
#  (6265, 168, 76) (6265, 168) (6265, 168) (6265, 168, 10)

# pickle_file = open('/home/xxx/ehr_data/los/los_mimic3_train_data_{}.pkl'.format(data_set_maxlen), 'wb')
# pickle.dump(train_dict, pickle_file)
# pickle_file.close()
#
# pickle_file = open('/home/xxx/ehr_data/los/los_mimic3_val_data_{}.pkl'.format(data_set_maxlen), 'wb')
# pickle.dump(val_dict, pickle_file)
# pickle_file.close()
#
# pickle_file = open('/home/xxx/ehr_data/los/los_mimic3_test_data_{}.pkl'.format(data_set_maxlen), 'wb')
# pickle.dump(test_dict, pickle_file)
# pickle_file.close()

pickle_file = open('/home/xxx/ehr_data/los/los_mimic3_train_data.pkl', 'wb')
pickle.dump(train_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/xxx/ehr_data/los/los_mimic3_val_data.pkl', 'wb')
pickle.dump(val_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/xxx/ehr_data/los/los_mimic3_test_data.pkl', 'wb')
pickle.dump(test_dict, pickle_file)
pickle_file.close()