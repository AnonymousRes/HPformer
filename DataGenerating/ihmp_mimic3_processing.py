...
parser.add_argument('--data', type=str, help='Path to the data of in-hospital mortality task',
                    default='/home/xxx/mimic3processed/in-hospital-mortality/')
...
#mimic3
#  (14681, 48, 76) (14681, 48) (14681, 48) (14681, 1)
#  (3222, 48, 76) (3222, 48) (3222, 48) (3222, 1)
#  (3236, 48, 76) (3236, 48) (3236, 48) (3236, 1)

pickle_file = open('/home/xxx/ehr_data/ihmp/ihmp_mimic3_train_data.pkl', 'wb')
pickle.dump(train_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/xxx/ehr_data/ihmp/ihmp_mimic3_val_data.pkl', 'wb')
pickle.dump(val_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/xxx/ehr_data/ihmp/ihmp_mimic3_test_data.pkl', 'wb')
